            ...
            e.exports = new b(function (b, d) {
              c.listen(function (b, c) {
                ...
                var d = c.get("ev"),
                  ...
                  h = c.get("dpost"),
                  i = !1;
                if (f && f.toUpperCase() === "LDU")
                  if (g === "1" && h === "1000") return;
                  else g === "0" && h === "0" && (i = !0);
                c.each(function (a, b) {
                  if (a) {
                    a = a.match(/^cd\[(.+)\]$/);
...
fbq.registerPlugin("558033215065722", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("558033215065722", "InferredEvents", true);
    fbq.loadPlugin("jsonld_microdata");
    instance.optIn("558033215065722", "MicrodataJsonLd", true);
    config.set("558033215065722", "automaticMatching", {
      selectedMatchKeys: ["em", "ct", "st", "zp"],
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("558033215065722", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("558033215065722", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    fbq.loadPlugin("inferredevents");
    instance.optIn("558033215065722", "IWLParameters", true);
    fbq.set("iwlExtractors", "558033215065722", []);
    fbq.loadPlugin("cookie");
    instance.optIn("558033215065722", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("microdata");
    fbq.loadPlugin("identity");
    instance.optIn("558033215065722", "AutomaticSetup", true);
    ...
    config.set("558033215065722", "prohibitedSources", {
      prohibitedSources: [],
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("558033215065722", "ProhibitedSources", true);
    config.set("558033215065722", "unwantedData", {
      blacklisted_keys: {},
      sensitive_keys: null,
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("558033215065722", "UnwantedData", true);
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("558033215065722", "IABPCMAEBridge", true);
    instance.configLoaded("558033215065722");
  },
});
