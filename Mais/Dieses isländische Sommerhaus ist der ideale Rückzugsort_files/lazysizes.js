...
!(function (e, t) {
  ...
  function u(e, t) {
    var a, r;
    d[e] ||
      ((a = n.createElement(t ? "link" : "script")),
    ...
    addEventListener(
      ...
      function (e) {
        ...
        if (e.detail.instance == i && !e.defaultPrevented) {
          ...
          if (
            ("none" == n.preload &&
              (n.preload = n.getAttribute("data-preload") || "auto"),
            null != n.getAttribute("data-autoplay"))
          )
            if (n.getAttribute("data-expand") && !n.autoplay)
              try {
                n.play();
              } catch (e) {}
            else
          ...
          (t = n.getAttribute("data-link")) &&
            "img" != n.tagName.toLowerCase() &&
            u(t, !0),
            (t = n.getAttribute("data-script")) && u(t),
            (t = n.getAttribute("data-require")) &&
              (i.cfg.requireJs ? i.cfg.requireJs([t]) : u(t)),
            (a = n.getAttribute("data-bg")) &&
