...
jQuery(document).ready(function ($) {
  ...
  $doc.on("click", ".lwa-changer", function (e) {
    ...
    linkParent
      .removeClass("lwa-active-1 lwa-active-2 lwa-active-3")
      .addClass("lwa-active-" + $(this).data("changer"));
  });
  ...
  $(".lwa-form").on("submit", function (event) {
    ...
    var formAction =
      typeof LWA !== "undefined"
        ? (formAction = LWA.ajaxurl)
        : form.attr("action");
    $.ajax({
      type: "POST",
      url: formAction,
  ...
  function lwaAjax(data, statusElement) {
    ...
    if (data.result === !0) {
      statusElement
        .attr("class", "lwa-status lwa-status-confirm")
        .html(data.message);
    } else if (data.result === !1) {
      statusElement
        .attr("class", "lwa-status lwa-status-invalid")
        .html(data.error);
    } else {
      statusElement
        .attr("class", "lwa-status lwa-status-invalid")
...
var borlabsCookiePrioritized = (function () {
  "use strict";
  var e = borlabsCookiePrioritized,
    o = {},
    t = "borlabs-cookie",
    i = [],
    n = !1,
    r = document.createDocumentFragment(),
    d = { prioritizedCodeUnblocked: null };
  (d.prioritizedCodeUnblocked = document.createEvent("Event")),
    d.prioritizedCodeUnblocked.initEvent(
      "borlabs-cookie-prioritized-code-unblocked",
      !0,
      !0
    );
  var a = function (e) {
    ...
    c = function (e) {
      ...
      for (var t in o)
        if (-1 !== o[t].indexOf("script>")) {
          ...
          var d = n.createContextualFragment(o[t]);
          i.appendChild(d), r.appendChild(i.firstElementChild);
        }
    };
  if (document.cookie.length) {
    for (var l = document.cookie.split(";"), s = 0; s < l.length; s++)
      try {
        l[s] = decodeURIComponent(l[s]);
        var p = l[s].split("="),
          v = void 0 !== p[0] ? p[0].trim() : "",
          m = void 0 !== p[1] ? p[1].trim() : "";
        if (v === t) {
          var b = JSON.parse(decodeURIComponent(m));
          void 0 !== b.domainPath &&
            b.domainPath === e.domain + e.path &&
            (o = b);
        }
      } catch (e) {
    ...
    if (
      (e.bots &&
        ...
        (n = !0),
      Object.keys(o).length > 0 && o.version === e.version && (n = !0),
      n)
    ) {
      for (var u in o.consents)
        for (var C in o.consents[u]) {
          var g = o.consents[u][C];
          void 0 !== e.optInJS[u] &&
            void 0 !== e.optInJS[u][g] &&
            (c(a(e.optInJS[u][g])), delete e.optInJS[u][g]);
        }
      document.getElementsByTagName("head")[0].appendChild(r),
        document.dispatchEvent(d.prioritizedCodeUnblocked);
    }
  }
  return e;
